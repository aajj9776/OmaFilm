    ...
    <div class="overlap-wrapper">
        <div class="overlap">
                ...
                <div class="overlap-group">
                        ...
                        <div class="frame-2">
                            <div>
                                <ol class="paging">
                                    ...
                                    <c:if test="${page.startPage >= page.pagePerBlock}">
                                        <li class=""><a
                                                href="Controller?type=adminNotice&cPage=${page.nowPage - page.pagePerBlock}">&lt;</a>
                                        </li>
                                    </c:if>
                                    <!-- <div class="nav"> -->
                    ...
                    <div class="cell-6">
                        <button type="button" class="text-wrapper-24"
                                onclick="deleteNotices()">삭제
                        </button>
                    </div>
                    <div class="bar">
                        <a href="Controller?type=adminInquiry" class="element">
                            <div
                                    class="text-wrapper-15">1:1 문의
                            </div>
                        </a>
            ...
            <div class="div-sidebar">
                ...
                <div class="list-2">
                    <div class="item-link">
                        <div class="text-wrapper-20"><a href="Controller?type=adminMovieDb">영화관리</a></div>
                    </div>
                    <div class="item-link-2"><a href="Controller?type=adminEvent" class="text-wrapper-21">이벤트/혜택 관리</a>
                    </div>
                    <div class="item-link-2">
                        <div class="text-wrapper-22"><a href="Controller?type=adminCpHome">쿠폰관리</a></div>
                    </div>
                    <div class="item-link-3">
                        <div class="text-wrapper-23"><a href="Controller?type=adminNotice">고객센터 관리</a></div>
                    </div>
                </div>
            </div>
        </div>
