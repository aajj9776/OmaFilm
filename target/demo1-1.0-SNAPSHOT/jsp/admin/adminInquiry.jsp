    ...
    <div class="overlap-wrapper">
        <div class="overlap">
            <div class="div-sidebar">
                ...
                <div class="list-2">
                    <div class="item-link"><div class="text-wrapper-21">영화관리</div></div>
                    <div class="item-link-2"><a href="Controller?type=adminEvent" class="text-wrapper-22">이벤트/혜택 관리</a></div>
                    <div class="item-link-2"><div class="text-wrapper-23">쿠폰 관리</div></div>
                    <div class="item-link-3"><div class="text-wrapper-24">고객센터 관리</div></div>
                </div>
            </div>
            <div class="div-con-wrap">
                ...
                <a href="Controller?type=adminFrequently" class="view">자주 묻는 질문</a>
                <a href="Controller?type=adminNotice" class="element">공지사항</a>
                                ...
                                <c:when test="${status.index == 0}">
                                    <div class="row">
                                        ...
                                        <div class="overlap-group-3">
                                            <div class="data"><div class="text-wrapper-17" name="idx">${inquiry.iq_idx}</div></div>
                                            <div class="data-2"><a href="Controller?type=adminComment&iq_idx=${inquiry.iq_idx}" class="p">${inquiry.iq_title}</a></div>
                                            <div class="data-4"><div class="text-wrapper-19">${inquiry.u_code } </div></div>
                                            <div class="data-5"><div class="text-wrapper-19">${inquiry.iq_none } </div></div>
                                            <div class="data-3"><div class="text-wrapper-8">${inquiry.iq_time}</div></div>
                                        </div>
                                        <div class="rectangle-wrapper">
                                            <input type="checkbox" class="rectangle" name="deleteiqIds" value="${inquiry.iq_idx}" /></div>
                                    </div>
                                </c:when>
                                <c:otherwise>
